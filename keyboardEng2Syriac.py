...
# Define key mapping for Syriac characters
key_map = {
    ...
    #'a': 'ܐ', 'b': 'ܒ', 'g': 'ܓ', 'd': 'ܕ', 'h': 'ܗ', 'w': 'ܘ', 'z': 'ܙ', 'x': 'ܚ', 't': 'ܛ',
    #'y': 'ܝ', 'k': 'ܟ', 'l': 'ܠ', 'm': 'ܡ', 'n': 'ܢ', 's': 'ܣ', 'e': 'ܥ', 'p': 'ܦ', 'c': 'ܨ',
    #'q': 'ܩ', 'r': 'ܪ', 'sh': 'ܫ', 't': 'ܬ',
    #'Shift-a': 'ܲ',  # Example vowel for Shift+A
    #'Alt-u': 'ܸ'     # Example vowel for Right Alt+U
}